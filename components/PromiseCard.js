...
export default function PromiseCard({ content, disabled }) {
  ...
  return (
    ...
    <div className="overflow-hidden mt-8 max-h-64 min-w-[350px] block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 hover:cursor-pointer">
      <div className="flex">
